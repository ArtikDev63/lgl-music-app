...
const LGLICON_MAX_SIZE = 192
const LGLICON_MIN_SIZE = 56
...
export default function SongScreen(){
    ...
    const animatedImageSize = useAnimatedStyle(() => {
        const imageSize = interpolate(
            scrollY.value,
            [0, SCROLL_DISTANCE],
            [LGLICON_MAX_SIZE, LGLICON_MIN_SIZE],
            Extrapolation.CLAMP,
        );
    ...
    return (
        <View style={defaultStyles.container}>
            <AnimatedLinearGradient style={[defaultStyles.container, styles.header, animatedHeaderStyle, {paddingTop: insets.top, height: 75 + insets.top}]}
                    ...
                    <Animated.Text style={[{...styles.titleText, color: "white", transform: [{translateY: 55}]}, animatedTextHeaderStyle]}>JC REYES</Animated.Text>
            ...
            <Animated.ScrollView style={[defaultStyles.container, {paddingBottom: tabBarToContentMargin.bottomPadding_NO_MiniPlayer + insets.bottom}]}
                ...
                <TrackList dataJSON={dataSongs} style={{paddingBottom: tabBarToContentMargin.bottomPadding_NO_MiniPlayer + insets.bottom}}/>
            </Animated.ScrollView>
        </View>
    );
}
